...
class Index extends Events {
    constructor(options) {
        ...
        // 透传 Jar 包
        let {
            root, paths, defaultEncoding, 
            URLEscapingCharset, numberFormat, templateUpdateDelay
        } = options;
        const {excludePort} = options;
        ...
        builder(excludePort, {root, defaultEncoding, URLEscapingCharset, numberFormat, templateUpdateDelay}).then(this.createRender.bind(this));
    }
